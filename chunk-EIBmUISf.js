...
`],encapsulation:2})}return i})(),nn=class i{_target;_ngZone;_platform;_containerElement;_triggerElement=null;_isPointerDown=false;_activeRipples=new Map;_mostRecentTransientRipple=null;_lastTouchStartEvent;_pointerUpEventsRegistered=false;_containerRect=null;static _eventManager=new di;constructor(a,e,t,n,r){this._target=a,this._ngZone=e,this._platform=n,n.isBrowser&&(this._containerElement=fe(t)),r&&r.get(ct$1).load(wo);}fadeInRipple(a,e,t={}){let n=this._containerRect=this._containerRect||this._containerElement.getBoundingClientRect(),r=B$1(B$1({},St),t.animation);t.centered&&(a=n.left+n.width/2,e=n.top+n.height/2);let o=t.radius||Do(a,e,n),l=a-n.left,c=e-n.top,p=r.enterDuration,h=document.createElement("div");h.classList.add("mat-ripple-element"),h.style.left=`${l-o}px`,h.style.top=`${c-o}px`,h.style.height=`${o*2}px`,h.style.width=`${o*2}px`,t.color!=null&&(h.style.backgroundColor=t.color),h.style.transitionDuration=`${p}ms`,this._containerElement.appendChild(h);let w=window.getComputedStyle(h),K=w.transitionProperty,$=w.transitionDuration,X=K==="none"||$==="0s"||$==="0s, 0s"||n.width===0&&n.height===0,j=new li(this,h,t,X);h.style.transform="scale3d(1, 1, 1)",j.state=ye.FADING_IN,t.persistent||(this._mostRecentTransientRipple=j);let He=null;return !X&&(p||r.exitDuration)&&this._ngZone.runOutsideAngular(()=>{let zi=()=>{He&&(He.fallbackTimer=null),clearTimeout(Hi),this._finishRippleTransition(j);},Rn=()=>this._destroyRipple(j),Hi=setTimeout(Rn,p+100);h.addEventListener("transitionend",zi),h.addEventListener("transitioncancel",Rn),He={onTransitionEnd:zi,onTransitionCancel:Rn,fallbackTimer:Hi};}),this._activeRipples.set(j,He),(X||!p)&&this._finishRippleTransition(j),j}fadeOutRipple(a){if(a.state===ye.FADING_OUT||a.state===ye.HIDDEN)return;let e=a.element,t=B$1(B$1({},St),a.config.animation);e.style.transitionDuration=`${t.exitDuration}ms`,e.style.opacity="0",a.state=ye.FADING_OUT,(a._animationForciblyDisabledThroughCss||!t.exitDuration)&&this._finishRippleTransition(a);}fadeOutAll(){this._getActiveRipples().forEach(a=>a.fadeOut());}fadeOutAllNonPersistent(){this._getActiveRipples().forEach(a=>{a.config.persistent||a.fadeOut();});}setupTriggerEvents(a){let e=fe(a);!this._platform.isBrowser||!e||e===this._triggerElement||(this._removeTriggerEvents(),this._triggerElement=e,Xa.forEach(t=>{i._eventManager.addHandler(this._ngZone,t,e,this);}));}handleEvent(a){a.type==="mousedown"?this._onMousedown(a):a.type==="touchstart"?this._onTouchStart(a):this._onPointerUp(),this._pointerUpEventsRegistered||(this._ngZone.runOutsideAngular(()=>{Ga.forEach(e=>{this._triggerElement.addEventListener(e,this,Wa);});}),this._pointerUpEventsRegistered=true);}_finishRippleTransition(a){a.state===ye.FADING_IN?this._startFadeOutTransition(a):a.state===ye.FADING_OUT&&this._destroyRipple(a);}_startFadeOutTransition(a){let e=a===this._mostRecentTransientRipple,{persistent:t}=a.config;a.state=ye.VISIBLE,!t&&(!e||!this._isPointerDown)&&a.fadeOut();}_destroyRipple(a){let e=this._activeRipples.get(a)??null;this._activeRipples.delete(a),this._activeRipples.size||(this._containerRect=null),a===this._mostRecentTransientRipple&&(this._mostRecentTransientRipple=null),a.state=ye.HIDDEN,e!==null&&(a.element.removeEventListener("transitionend",e.onTransitionEnd),a.element.removeEventListener("transitioncancel",e.onTransitionCancel),e.fallbackTimer!==null&&clearTimeout(e.fallbackTimer)),a.element.remove();}_onMousedown(a){let e=Dt(a),t=this._lastTouchStartEvent&&Date.now()<this._lastTouchStartEvent+xo;!this._target.rippleDisabled&&!e&&!t&&(this._isPointerDown=true,this.fadeInRipple(a.clientX,a.clientY,this._target.rippleConfig));}_onTouchStart(a){if(!this._target.rippleDisabled&&!Ct(a)){this._lastTouchStartEvent=Date.now(),this._isPointerDown=true;let e=a.changedTouches;if(e)for(let t=0;t<e.length;t++)this.fadeInRipple(e[t].clientX,e[t].clientY,this._target.rippleConfig);}}_onPointerUp(){this._isPointerDown&&(this._isPointerDown=false,this._getActiveRipples().forEach(a=>{let e=a.state===ye.VISIBLE||a.config.terminateOnPointerUp&&a.state===ye.FADING_IN;!a.config.persistent&&e&&a.fadeOut();}));}_getActiveRipples(){return Array.from(this._activeRipples.keys())}_removeTriggerEvents(){let a=this._triggerElement;a&&(Xa.forEach(e=>i._eventManager.removeHandler(e,a,this)),this._pointerUpEventsRegistered&&(Ga.forEach(e=>a.removeEventListener(e,this,Wa)),this._pointerUpEventsRegistered=false));}};function Do(i,a,e){let t=Math.max(Math.abs(i-e.left),Math.abs(i-e.right)),n=Math.max(Math.abs(a-e.top),Math.abs(a-e.bottom));return Math.sqrt(t*t+n*n)}var Za=new C$1("mat-ripple-global-options");var an=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["structural-styles"]],decls:0,vars:0,template:function(t,n){},styles:[`.mat-focus-indicator {
  position: relative;
}
...
`],encapsulation:2})}return i})();var Vo=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]],[["","progressIndicator",""]]],Bo=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]","[progressIndicator]"];function zo(i,a){i&1&&(_u(0,"div",2),rw(1,3),Su());}var gr=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),Di=(()=>{class i extends wi{get appearance(){return this._appearance}set appearance(e){this.setAppearance(e||this._config?.defaultAppearance||"text");}_appearance=null;constructor(){super();let e=Ho(this._elementRef.nativeElement);e&&this.setAppearance(e);}setAppearance(e){if(e===this._appearance)return;let t=this._elementRef.nativeElement.classList,n=this._appearance?gr.get(this._appearance):null,r=gr.get(e);n&&t.remove(...n),t.add(...r),this._appearance=e;}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[Ih],ngContentSelectors:Bo,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(t,n){t&1&&(nw(Vo),kh(0,"span",0),rw(1),_u(2,"span",1),rw(3,1),Su(),rw(4,2),$I(5,zo,2,0,"div",2),kh(6,"span",3)(7,"span",4)),t&2&&(Zh("mdc-button__ripple",!n._isFab)("mdc-fab__ripple",n._isFab),TD(5),zI(n.showProgress()?5:-1));},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2})}return i})();var yn=new C$1("MAT_INPUT_VALUE_ACCESSOR");var Ci=class{_box;_destroyed=new re;_resizeSubject=new re;_resizeObserver;_elementObservables=new Map;constructor(a){this._box=a,typeof ResizeObserver<"u"&&(this._resizeObserver=new ResizeObserver(e=>this._resizeSubject.next(e)));}observe(a){return this._elementObservables.has(a)||this._elementObservables.set(a,new x(e=>{let t=this._resizeSubject.subscribe(e);return this._resizeObserver?.observe(a,{box:this._box}),()=>{this._resizeObserver?.unobserve(a),t.unsubscribe(),this._elementObservables.delete(a);}}).pipe(gt$1(e=>e.some(t=>t.target===a)),Rm({bufferSize:1,refCount:true}),km(this._destroyed))),this._elementObservables.get(a)}destroy(){this._destroyed.next(),this._destroyed.complete(),this._resizeSubject.complete(),this._elementObservables.clear();}},xr=(()=>{class i{_cleanupErrorListener;_observers=new Map;_ngZone=y(te);constructor(){}ngOnDestroy(){for(let[,e]of this._observers)e.destroy();this._observers.clear(),this._cleanupErrorListener?.();}observe(e,t){let n=t?.box||"content-box";return this._observers.has(n)||this._observers.set(n,new Ci(n)),this._observers.get(n).observe(e)}static \u0275fac=function(t){return new(t||i)};static \u0275prov=We$1({token:i,factory:i.\u0275fac})}return i})();var Qo=["notch"],Jo=["*"],wr=["iconPrefixContainer"],Dr=["textPrefixContainer"],Cr=["iconSuffixContainer"],Er=["textSuffixContainer"],es=["textField"],ts=["*",[["mat-label"]],[["","matPrefix",""],["","matIconPrefix",""]],[["","matTextPrefix",""]],[["","matTextSuffix",""]],[["","matSuffix",""],["","matIconSuffix",""]],[["mat-error"],["","matError",""]],[["mat-hint",3,"align","end"]],[["mat-hint","align","end"]]],ns=["*","mat-label","[matPrefix], [matIconPrefix]","[matTextPrefix]","[matTextSuffix]","[matSuffix], [matIconSuffix]","mat-error, [matError]","mat-hint:not([align='end'])","mat-hint[align='end']"];function is(i,a){i&1&&Oh(0,"span",21);}function as(i,a){if(i&1&&(zi(0,"label",20),rw(1,1),$I(2,is,1,0,"span",21),bu()),i&2){let e=ew(2);Rh("floating",e._shouldLabelFloat())("monitorResize",e._hasOutline())("id",e._labelId),xh("for",e._control.disableAutomaticLabeling?null:e._control.id),TD(2),zI(!e.hideRequiredMarker&&e._control.required?2:-1);}}function rs(i,a){if(i&1&&$I(0,as,3,5,"label",20),i&2){let e=ew();zI(e._hasFloatingLabel()?0:-1);}}function os(i,a){i&1&&Oh(0,"div",7);}function ss(i,a){}function ls(i,a){if(i&1&&Ch(0,ss,0,0,"ng-template",13),i&2){ew(2);let e=cw(1);Rh("ngTemplateOutlet",e);}}function ds(i,a){if(i&1&&(zi(0,"div",9),$I(1,ls,1,1,null,13),bu()),i&2){let e=ew();Rh("matFormFieldNotchedOutlineOpen",e._shouldLabelFloat()),TD(),zI(e._forceDisplayInfixLabel()?-1:1);}}function cs(i,a){i&1&&(zi(0,"div",10,2),rw(2,2),bu());}function ms(i,a){i&1&&(zi(0,"div",11,3),rw(2,3),bu());}function us(i,a){}function hs(i,a){if(i&1&&Ch(0,us,0,0,"ng-template",13),i&2){ew();let e=cw(1);Rh("ngTemplateOutlet",e);}}function ps(i,a){i&1&&(zi(0,"div",14,4),rw(2,4),bu());}function fs(i,a){i&1&&(zi(0,"div",15,5),rw(2,5),bu());}function _s(i,a){i&1&&Oh(0,"div",16);}function gs(i,a){i&1&&(zi(0,"div",18),rw(1,6),bu());}function bs(i,a){if(i&1&&(zi(0,"mat-hint",22),Aw(1),bu()),i&2){let e=ew(2);Rh("id",e._hintLabelId),TD(),eg(e.hintLabel);}}function vs(i,a){if(i&1&&(zi(0,"div",19),$I(1,bs,2,2,"mat-hint",22),rw(2,7),Oh(3,"div",23),rw(4,8),bu()),i&2){let e=ew();TD(),zI(e.hintLabel?1:-1);}}var Ei=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["mat-label"]]})}return i})(),ys=new C$1("MatError");var Mi=(()=>{class i{align="start";id=y(ce).getId("mat-mdc-hint-");static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["mat-hint"]],hostAttrs:[1,"mat-mdc-form-field-hint","mat-mdc-form-field-bottom-align"],hostVars:4,hostBindings:function(t,n){t&2&&(Ph("id",n.id),xh("align",null),Zh("mat-mdc-form-field-hint-end",n.align==="end"));},inputs:{align:"align",id:"id"}})}return i})(),Or=new C$1("MatPrefix"),Si=(()=>{class i{set _isTextSelector(e){this._isText=true;}_isText=false;static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["","matPrefix",""],["","matIconPrefix",""],["","matTextPrefix",""]],inputs:{_isTextSelector:[0,"matTextPrefix","_isTextSelector"]},features:[Bw([{provide:Or,useExisting:i}])]})}return i})(),Fr=new C$1("MatSuffix"),ki=(()=>{class i{set _isTextSelector(e){this._isText=true;}_isText=false;static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["","matSuffix",""],["","matIconSuffix",""],["","matTextSuffix",""]],inputs:{_isTextSelector:[0,"matTextSuffix","_isTextSelector"]},features:[Bw([{provide:Fr,useExisting:i}])]})}return i})(),Ir=new C$1("FloatingLabelParent"),Mr=(()=>{class i{_elementRef=y(qn$1);get floating(){return this._floating}set floating(e){this._floating=e,this.monitorResize&&this._handleResize();}_floating=false;get monitorResize(){return this._monitorResize}set monitorResize(e){this._monitorResize=e,this._monitorResize?this._subscribeToResize():this._resizeSubscription.unsubscribe();}_monitorResize=false;_resizeObserver=y(xr);_ngZone=y(te);_parent=y(Ir);_resizeSubscription=new Y$1;ngOnDestroy(){this._resizeSubscription.unsubscribe();}getWidth(){return xs(this._elementRef.nativeElement)}get element(){return this._elementRef.nativeElement}_handleResize(){setTimeout(()=>this._parent._handleLabelResized());}_subscribeToResize(){this._resizeSubscription.unsubscribe(),this._ngZone.runOutsideAngular(()=>{this._resizeSubscription=this._resizeObserver.observe(this._elementRef.nativeElement,{box:"border-box"}).subscribe(()=>this._handleResize());});}static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["label","matFormFieldFloatingLabel",""]],hostAttrs:[1,"mdc-floating-label","mat-mdc-floating-label"],hostVars:2,hostBindings:function(t,n){t&2&&Zh("mdc-floating-label--float-above",n.floating);},inputs:{floating:"floating",monitorResize:"monitorResize"}})}return i})();function xs(i){let a=i;if(a.offsetParent!==null)return a.scrollWidth;let e=a.cloneNode(true);e.style.setProperty("position","absolute"),e.style.setProperty("transform","translate(-9999px, -9999px)"),document.documentElement.appendChild(e);let t=e.scrollWidth;return e.remove(),t}var Sr="mdc-line-ripple--active",xn="mdc-line-ripple--deactivating",kr=(()=>{class i{_elementRef=y(qn$1);_cleanupTransitionEnd;constructor(){let e=y(te),t=y(Kp);e.runOutsideAngular(()=>{this._cleanupTransitionEnd=t.listen(this._elementRef.nativeElement,"transitionend",this._handleTransitionEnd);});}activate(){let e=this._elementRef.nativeElement.classList;e.remove(xn),e.add(Sr);}deactivate(){this._elementRef.nativeElement.classList.add(xn);}_handleTransitionEnd=e=>{let t=this._elementRef.nativeElement.classList,n=t.contains(xn);e.propertyName==="opacity"&&n&&t.remove(Sr,xn);};ngOnDestroy(){this._cleanupTransitionEnd();}static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["div","matFormFieldLineRipple",""]],hostAttrs:[1,"mdc-line-ripple"]})}return i})(),Ar=(()=>{class i{_elementRef=y(qn$1);_ngZone=y(te);open=false;_notch;ngAfterViewInit(){let e=this._elementRef.nativeElement,t=e.querySelector(".mdc-floating-label");t?(e.classList.add("mdc-notched-outline--upgraded"),typeof requestAnimationFrame=="function"&&(t.style.transitionDuration="0s",this._ngZone.runOutsideAngular(()=>{requestAnimationFrame(()=>t.style.transitionDuration="");}))):e.classList.add("mdc-notched-outline--no-label");}_setNotchWidth(e){let t=this._notch.nativeElement;!this.open||!e?t.style.width="":t.style.width=`calc(${e}px * var(--mat-mdc-form-field-floating-label-scale, 0.75) + 9px)`;}_setMaxWidth(e){this._notch.nativeElement.style.setProperty("--mat-form-field-notch-max-width",`calc(100% - ${e}px)`);}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["div","matFormFieldNotchedOutline",""]],viewQuery:function(t,n){if(t&1&&Uh(Qo,5),t&2){let r;iw(r=sw())&&(n._notch=r.first);}},hostAttrs:[1,"mdc-notched-outline"],hostVars:2,hostBindings:function(t,n){t&2&&Zh("mdc-notched-outline--notched",n.open);},inputs:{open:[0,"matFormFieldNotchedOutlineOpen","open"]},ngContentSelectors:Jo,decls:5,vars:0,consts:[["notch",""],[1,"mat-mdc-notch-piece","mdc-notched-outline__leading"],[1,"mat-mdc-notch-piece","mdc-notched-outline__notch"],[1,"mat-mdc-notch-piece","mdc-notched-outline__trailing"]],template:function(t,n){t&1&&(nw(),kh(0,"div",1),_u(1,"div",2,0),rw(3),Su(),kh(4,"div",3));},encapsulation:2})}return i})(),wn=(()=>{class i{value=null;stateChanges;id;placeholder;ngControl=null;focused=false;empty=false;shouldLabelFloat=false;required=false;disabled=false;errorState=false;controlType;autofilled;userAriaDescribedBy;disableAutomaticLabeling;describedByIds;static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i})}return i})();var Ot=new C$1("MatFormField"),ws=new C$1("MAT_FORM_FIELD_DEFAULT_OPTIONS"),Rr="fill",Ds="auto",Tr="fixed",Cs="translateY(-50%)",Dn=(()=>{class i{_elementRef=y(qn$1);_changeDetectorRef=y(DC);_platform=y(C);_idGenerator=y(ce);_ngZone=y(te);_defaults=y(ws,{optional:true});_currentDirection;_textField;_iconPrefixContainer;_textPrefixContainer;_iconSuffixContainer;_textSuffixContainer;_floatingLabel;_notchedOutline;_lineRipple;_iconPrefixContainerSignal=bL("iconPrefixContainer");_textPrefixContainerSignal=bL("textPrefixContainer");_iconSuffixContainerSignal=bL("iconSuffixContainer");_textSuffixContainerSignal=bL("textSuffixContainer");_prefixSuffixContainers=Zw(()=>[this._iconPrefixContainerSignal(),this._textPrefixContainerSignal(),this._iconSuffixContainerSignal(),this._textSuffixContainerSignal()].map(e=>e?.nativeElement).filter(e=>e!==void 0));_formFieldControl;_prefixChildren;_suffixChildren;_errorChildren;_hintChildren;_labelChild=_L(Ei);get hideRequiredMarker(){return this._hideRequiredMarker}set hideRequiredMarker(e){this._hideRequiredMarker=Re(e);}_hideRequiredMarker=false;color="primary";get floatLabel(){return this._floatLabel||this._defaults?.floatLabel||Ds}set floatLabel(e){e!==this._floatLabel&&(this._floatLabel=e,this._changeDetectorRef.markForCheck());}_floatLabel;get appearance(){return this._appearanceSignal()}set appearance(e){let t=e||this._defaults?.appearance||Rr;this._appearanceSignal.set(t);}_appearanceSignal=pi(Rr);get subscriptSizing(){return this._subscriptSizing||this._defaults?.subscriptSizing||Tr}set subscriptSizing(e){this._subscriptSizing=e||this._defaults?.subscriptSizing||Tr;}_subscriptSizing=null;get hintLabel(){return this._hintLabel}set hintLabel(e){this._hintLabel=e,this._processHints();}_hintLabel="";_hasIconPrefix=false;_hasTextPrefix=false;_hasIconSuffix=false;_hasTextSuffix=false;_labelId=this._idGenerator.getId("mat-mdc-form-field-label-");_hintLabelId=this._idGenerator.getId("mat-mdc-hint-");_describedByIds;get _control(){return this._explicitFormFieldControl||this._formFieldControl}set _control(e){this._explicitFormFieldControl=e;}_destroyed=new re;_isFocused=null;_explicitFormFieldControl;_previousControl=null;_previousControlValidatorFn=null;_stateChanges;_valueChanges;_describedByChanges;_outlineLabelOffsetResizeObserver=null;_animationsDisabled=ve();constructor(){let e=this._defaults,t=y(gt);e&&(e.appearance&&(this.appearance=e.appearance),this._hideRequiredMarker=!!e?.hideRequiredMarker,e.color&&(this.color=e.color)),jd(()=>this._currentDirection=t.valueSignal()),this._syncOutlineLabelOffset();}ngAfterViewInit(){this._updateFocusState(),this._animationsDisabled||this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{this._elementRef.nativeElement.classList.add("mat-form-field-animations-enabled");},300);}),this._changeDetectorRef.detectChanges();}ngAfterContentInit(){this._assertFormFieldControl(),this._initializeSubscript(),this._initializePrefixAndSuffix();}ngAfterContentChecked(){this._assertFormFieldControl(),this._control!==this._previousControl&&(this._initializeControl(this._previousControl),this._control.ngControl&&this._control.ngControl.control&&(this._previousControlValidatorFn=this._control.ngControl.control.validator),this._previousControl=this._control),this._control.ngControl&&this._control.ngControl.control&&this._control.ngControl.control.validator!==this._previousControlValidatorFn&&this._changeDetectorRef.markForCheck();}ngOnDestroy(){this._outlineLabelOffsetResizeObserver?.disconnect(),this._stateChanges?.unsubscribe(),this._valueChanges?.unsubscribe(),this._describedByChanges?.unsubscribe(),this._destroyed.next(),this._destroyed.complete();}getLabelId=Zw(()=>this._hasFloatingLabel()?this._labelId:null);getConnectedOverlayOrigin(){return this._textField||this._elementRef}_animateAndLockLabel(){this._hasFloatingLabel()&&(this.floatLabel="always");}_initializeControl(e){let t=this._control,n="mat-mdc-form-field-type-";e&&this._elementRef.nativeElement.classList.remove(n+e.controlType),t.controlType&&this._elementRef.nativeElement.classList.add(n+t.controlType),this._stateChanges?.unsubscribe(),this._stateChanges=t.stateChanges.subscribe(()=>{this._updateFocusState(),this._changeDetectorRef.markForCheck();}),this._describedByChanges?.unsubscribe(),this._describedByChanges=t.stateChanges.pipe(El([void 0,void 0]),de$1(()=>[t.errorState,t.userAriaDescribedBy]),xm(),gt$1(([[r,o],[l,c]])=>r!==l||o!==c)).subscribe(()=>this._syncDescribedByIds()),this._valueChanges?.unsubscribe(),t.ngControl&&t.ngControl.valueChanges&&(this._valueChanges=t.ngControl.valueChanges.pipe(km(this._destroyed)).subscribe(()=>this._changeDetectorRef.markForCheck()));}_checkPrefixAndSuffixTypes(){this._hasIconPrefix=!!this._prefixChildren.find(e=>!e._isText),this._hasTextPrefix=!!this._prefixChildren.find(e=>e._isText),this._hasIconSuffix=!!this._suffixChildren.find(e=>!e._isText),this._hasTextSuffix=!!this._suffixChildren.find(e=>e._isText);}_initializePrefixAndSuffix(){this._checkPrefixAndSuffixTypes(),Cm(this._prefixChildren.changes,this._suffixChildren.changes).subscribe(()=>{this._checkPrefixAndSuffixTypes(),this._changeDetectorRef.markForCheck();});}_initializeSubscript(){this._hintChildren.changes.subscribe(()=>{this._processHints(),this._changeDetectorRef.markForCheck();}),this._errorChildren.changes.subscribe(()=>{this._syncDescribedByIds(),this._changeDetectorRef.markForCheck();}),this._validateHints(),this._syncDescribedByIds();}_assertFormFieldControl(){this._control;}_updateFocusState(){let e=this._control.focused;e&&!this._isFocused?(this._isFocused=true,this._lineRipple?.activate()):!e&&(this._isFocused||this._isFocused===null)&&(this._isFocused=false,this._lineRipple?.deactivate()),this._elementRef.nativeElement.classList.toggle("mat-focused",e),this._textField?.nativeElement.classList.toggle("mdc-text-field--focused",e);}_syncOutlineLabelOffset(){AL({earlyRead:()=>{if(this._appearanceSignal()!=="outline")return this._outlineLabelOffsetResizeObserver?.disconnect(),null;if(globalThis.ResizeObserver){this._outlineLabelOffsetResizeObserver||=new globalThis.ResizeObserver(()=>{this._writeOutlinedLabelStyles(this._getOutlinedLabelOffset());});for(let e of this._prefixSuffixContainers())this._outlineLabelOffsetResizeObserver.observe(e,{box:"border-box"});}return this._getOutlinedLabelOffset()},write:e=>this._writeOutlinedLabelStyles(e())});}_shouldAlwaysFloat(){return this.floatLabel==="always"}_hasOutline(){return this.appearance==="outline"}_forceDisplayInfixLabel(){return !this._platform.isBrowser&&this._prefixChildren.length&&!this._shouldLabelFloat()}_hasFloatingLabel=Zw(()=>!!this._labelChild());_shouldLabelFloat(){return this._hasFloatingLabel()?this._control.shouldLabelFloat||this._shouldAlwaysFloat():false}_shouldForward(e){let t=this._control?this._control.ngControl:null;return t&&t[e]}_getSubscriptMessageType(){return this._errorChildren&&this._errorChildren.length>0&&this._control.errorState?"error":"hint"}_handleLabelResized(){this._refreshOutlineNotchWidth();}_refreshOutlineNotchWidth(){!this._hasOutline()||!this._floatingLabel||!this._shouldLabelFloat()?this._notchedOutline?._setNotchWidth(0):this._notchedOutline?._setNotchWidth(this._floatingLabel.getWidth());}_processHints(){this._validateHints(),this._syncDescribedByIds();}_validateHints(){this._hintChildren;}_syncDescribedByIds(){if(this._control){let e=[];if(this._control.userAriaDescribedBy&&typeof this._control.userAriaDescribedBy=="string"&&e.push(...this._control.userAriaDescribedBy.split(" ")),this._getSubscriptMessageType()==="hint"){let r=this._hintChildren?this._hintChildren.find(l=>l.align==="start"):null,o=this._hintChildren?this._hintChildren.find(l=>l.align==="end"):null;r?e.push(r.id):this._hintLabel&&e.push(this._hintLabelId),o&&e.push(o.id);}else this._errorChildren&&e.push(...this._errorChildren.map(r=>r.id));let t=this._control.describedByIds,n;if(t){let r=this._describedByIds||e;n=e.concat(t.filter(o=>o&&!r.includes(o)));}else n=e;this._control.setDescribedByIds(n),this._describedByIds=e;}}_getOutlinedLabelOffset(){if(!this._hasOutline()||!this._floatingLabel)return null;if(!this._iconPrefixContainer&&!this._textPrefixContainer)return ["",null];if(!this._isAttachedToDom())return null;let e=this._iconPrefixContainer?.nativeElement,t=this._textPrefixContainer?.nativeElement,n=this._iconSuffixContainer?.nativeElement,r=this._textSuffixContainer?.nativeElement,o=e?.getBoundingClientRect().width??0,l=t?.getBoundingClientRect().width??0,c=n?.getBoundingClientRect().width??0,p=r?.getBoundingClientRect().width??0,h=this._currentDirection==="rtl"?"-1":"1",w=`${o+l}px`,$=`calc(${h} * (${w} + var(--mat-mdc-form-field-label-offset-x, 0px)))`,X=`var(--mat-mdc-form-field-label-transform, ${Cs} translateX(${$}))`,j=o+l+c+p;return [X,j]}_writeOutlinedLabelStyles(e){if(e!==null){let[t,n]=e;this._floatingLabel&&(this._floatingLabel.element.style.transform=t),n!==null&&this._notchedOutline?._setMaxWidth(n);}}_isAttachedToDom(){let e=this._elementRef.nativeElement;if(e.getRootNode){let t=e.getRootNode();return t&&t!==e}return document.documentElement.contains(e)}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["mat-form-field"]],contentQueries:function(t,n,r){if(t&1&&($h(r,n._labelChild,Ei,5),Hh(r,wn,5)(r,Or,5)(r,Fr,5)(r,ys,5)(r,Mi,5)),t&2){aw();let o;iw(o=sw())&&(n._formFieldControl=o.first),iw(o=sw())&&(n._prefixChildren=o),iw(o=sw())&&(n._suffixChildren=o),iw(o=sw())&&(n._errorChildren=o),iw(o=sw())&&(n._hintChildren=o);}},viewQuery:function(t,n){if(t&1&&(zh(n._iconPrefixContainerSignal,wr,5)(n._textPrefixContainerSignal,Dr,5)(n._iconSuffixContainerSignal,Cr,5)(n._textSuffixContainerSignal,Er,5),Uh(es,5)(wr,5)(Dr,5)(Cr,5)(Er,5)(Mr,5)(Ar,5)(kr,5)),t&2){aw(4);let r;iw(r=sw())&&(n._textField=r.first),iw(r=sw())&&(n._iconPrefixContainer=r.first),iw(r=sw())&&(n._textPrefixContainer=r.first),iw(r=sw())&&(n._iconSuffixContainer=r.first),iw(r=sw())&&(n._textSuffixContainer=r.first),iw(r=sw())&&(n._floatingLabel=r.first),iw(r=sw())&&(n._notchedOutline=r.first),iw(r=sw())&&(n._lineRipple=r.first);}},hostAttrs:[1,"mat-mdc-form-field"],hostVars:38,hostBindings:function(t,n){t&2&&Zh("mat-mdc-form-field-label-always-float",n._shouldAlwaysFloat())("mat-mdc-form-field-has-icon-prefix",n._hasIconPrefix)("mat-mdc-form-field-has-icon-suffix",n._hasIconSuffix)("mat-form-field-invalid",n._control.errorState)("mat-form-field-disabled",n._control.disabled)("mat-form-field-autofilled",n._control.autofilled)("mat-form-field-appearance-fill",n.appearance=="fill")("mat-form-field-appearance-outline",n.appearance=="outline")("mat-form-field-hide-placeholder",n._hasFloatingLabel()&&!n._shouldLabelFloat())("mat-primary",n.color!=="accent"&&n.color!=="warn")("mat-accent",n.color==="accent")("mat-warn",n.color==="warn")("ng-untouched",n._shouldForward("untouched"))("ng-touched",n._shouldForward("touched"))("ng-pristine",n._shouldForward("pristine"))("ng-dirty",n._shouldForward("dirty"))("ng-valid",n._shouldForward("valid"))("ng-invalid",n._shouldForward("invalid"))("ng-pending",n._shouldForward("pending"));},inputs:{hideRequiredMarker:"hideRequiredMarker",color:"color",floatLabel:"floatLabel",appearance:"appearance",subscriptSizing:"subscriptSizing",hintLabel:"hintLabel"},exportAs:["matFormField"],features:[Bw([{provide:Ot,useExisting:i},{provide:Ir,useExisting:i}])],ngContentSelectors:ns,decls:18,vars:21,consts:[["labelTemplate",""],["textField",""],["iconPrefixContainer",""],["textPrefixContainer",""],["textSuffixContainer",""],["iconSuffixContainer",""],[1,"mat-mdc-text-field-wrapper","mdc-text-field",3,"click"],[1,"mat-mdc-form-field-focus-overlay"],[1,"mat-mdc-form-field-flex"],["matFormFieldNotchedOutline","",3,"matFormFieldNotchedOutlineOpen"],[1,"mat-mdc-form-field-icon-prefix"],[1,"mat-mdc-form-field-text-prefix"],[1,"mat-mdc-form-field-infix"],[3,"ngTemplateOutlet"],[1,"mat-mdc-form-field-text-suffix"],[1,"mat-mdc-form-field-icon-suffix"],["matFormFieldLineRipple",""],["aria-atomic","true","aria-live","polite",1,"mat-mdc-form-field-subscript-wrapper","mat-mdc-form-field-bottom-align"],[1,"mat-mdc-form-field-error-wrapper"],[1,"mat-mdc-form-field-hint-wrapper"],["matFormFieldFloatingLabel","",3,"floating","monitorResize","id"],["aria-hidden","true",1,"mat-mdc-form-field-required-marker","mdc-floating-label--required"],[3,"id"],[1,"mat-mdc-form-field-hint-spacer"]],template:function(t,n){if(t&1&&(nw(ts),Ch(0,rs,1,1,"ng-template",null,0,Gw),zi(2,"div",6,1),jh("click",function(o){return n._control.onContainerClick(o)}),$I(4,os,1,0,"div",7),zi(5,"div",8),$I(6,ds,2,2,"div",9),$I(7,cs,3,0,"div",10),$I(8,ms,3,0,"div",11),zi(9,"div",12),$I(10,hs,1,1,null,13),rw(11),bu(),$I(12,ps,3,0,"div",14),$I(13,fs,3,0,"div",15),bu(),$I(14,_s,1,0,"div",16),bu(),zi(15,"div",17),$I(16,gs,2,0,"div",18)(17,vs,5,1,"div",19),bu()),t&2){let r;TD(2),Zh("mdc-text-field--filled",!n._hasOutline())("mdc-text-field--outlined",n._hasOutline())("mdc-text-field--no-label",!n._hasFloatingLabel())("mdc-text-field--disabled",n._control.disabled)("mdc-text-field--invalid",n._control.errorState),TD(2),zI(!n._hasOutline()&&!n._control.disabled?4:-1),TD(2),zI(n._hasOutline()?6:-1),TD(),zI(n._hasIconPrefix?7:-1),TD(),zI(n._hasTextPrefix?8:-1),TD(2),zI(!n._hasOutline()||n._forceDisplayInfixLabel()?10:-1),TD(2),zI(n._hasTextSuffix?12:-1),TD(),zI(n._hasIconSuffix?13:-1),TD(),zI(n._hasOutline()?-1:14),TD(),Zh("mat-mdc-form-field-subscript-dynamic-size",n.subscriptSizing==="dynamic");let o=n._getSubscriptMessageType();TD(),zI((r=o)==="error"?16:r==="hint"?17:-1);}},dependencies:[Mr,Ar,FC,kr,Mi],styles:[`.mdc-text-field {
  display: inline-flex;
...
`],encapsulation:2})}return i})();function Es(i,a){return this._trackRow(a)}var Hr=(i,a)=>a.id;function Ms(i,a){if(i&1&&(_u(0,"tr",0)(1,"td",3),Aw(2),Su()()),i&2){let e=ew();TD(),qh("padding-top",e._cellPadding)("padding-bottom",e._cellPadding),xh("colspan",e.numCols),TD(),Mu(" ",e.label," ");}}function Ss(i,a){if(i&1&&(_u(0,"td",3),Aw(1),Su()),i&2){let e=ew(2);qh("padding-top",e._cellPadding)("padding-bottom",e._cellPadding),xh("colspan",e._firstRowOffset),TD(),Mu(" ",e._firstRowOffset>=e.labelMinRequiredCells?e.label:""," ");}}function ks(i,a){if(i&1){let e=XI();_u(0,"td",6)(1,"button",7),Bh("click",function(n){let r=yd(e).$implicit,o=ew(2);return vd(o._cellClicked(r,n))})("focus",function(n){let r=yd(e).$implicit,o=ew(2);return vd(o._emitActiveDateChange(r,n))}),_u(2,"span",8),Aw(3),Su(),kh(4,"span",9),Su()();}if(i&2){let e=a.$implicit,t=a.$index,n=ew().$index,r=ew();qh("width",r._cellWidth)("padding-top",r._cellPadding)("padding-bottom",r._cellPadding),xh("data-mat-row",n)("data-mat-col",t),TD(),Dw(e.cssClasses),Zh("mat-calendar-body-disabled",!e.enabled)("mat-calendar-body-active",r._isActiveCell(n,t))("mat-calendar-body-range-start",r._isRangeStart(e.compareValue))("mat-calendar-body-range-end",r._isRangeEnd(e.compareValue))("mat-calendar-body-in-range",r._isInRange(e.compareValue))("mat-calendar-body-comparison-bridge-start",r._isComparisonBridgeStart(e.compareValue,n,t))("mat-calendar-body-comparison-bridge-end",r._isComparisonBridgeEnd(e.compareValue,n,t))("mat-calendar-body-comparison-start",r._isComparisonStart(e.compareValue))("mat-calendar-body-comparison-end",r._isComparisonEnd(e.compareValue))("mat-calendar-body-in-comparison-range",r._isInComparisonRange(e.compareValue))("mat-calendar-body-preview-start",r._isPreviewStart(e.compareValue))("mat-calendar-body-preview-end",r._isPreviewEnd(e.compareValue))("mat-calendar-body-in-preview",r._isInPreview(e.compareValue)),Ph("tabIndex",r._isActiveCell(n,t)?0:-1),xh("aria-label",e.ariaLabel)("aria-disabled",!e.enabled||null)("aria-pressed",r._isSelected(e.compareValue))("aria-current",r.todayValue===e.compareValue?"date":null)("aria-describedby",r._getDescribedby(e.compareValue)),TD(),Zh("mat-calendar-body-selected",r._isSelected(e.compareValue))("mat-calendar-body-comparison-identical",r._isComparisonIdentical(e.compareValue))("mat-calendar-body-today",r.todayValue===e.compareValue),TD(),Mu(" ",e.displayValue," ");}}function As(i,a){if(i&1&&(_u(0,"tr",1),$I(1,Ss,2,6,"td",4),WI(2,ks,5,49,"td",5,Hr),Su()),i&2){let e=a.$implicit,t=a.$index,n=ew();TD(),zI(t===0&&n._firstRowOffset?1:-1),TD(),qI(e);}}function Rs(i,a){if(i&1&&(zi(0,"th",2)(1,"span",6),Aw(2),bu(),zi(3,"span",3),Aw(4),bu()()),i&2){let e=a.$implicit;TD(2),eg(e.long),TD(2),eg(e.narrow);}}var Ts=["*"];function Os(i,a){}function Fs(i,a){if(i&1){let e=XI();zi(0,"mat-month-view",4),og("activeDateChange",function(n){yd(e);let r=ew();return Fw(r.activeDate,n)||(r.activeDate=n),vd(n)}),jh("_userSelection",function(n){yd(e);let r=ew();return vd(r._dateSelected(n))})("dragStarted",function(n){yd(e);let r=ew();return vd(r._dragStarted(n))})("dragEnded",function(n){yd(e);let r=ew();return vd(r._dragEnded(n))}),bu();}if(i&2){let e=ew();rg("activeDate",e.activeDate),Rh("selected",e.selected)("dateFilter",e.dateFilter)("maxDate",e.maxDate)("minDate",e.minDate)("dateClass",e.dateClass)("comparisonStart",e.comparisonStart)("comparisonEnd",e.comparisonEnd)("startDateAccessibleName",e.startDateAccessibleName)("endDateAccessibleName",e.endDateAccessibleName)("activeDrag",e._activeDrag);}}function Is(i,a){if(i&1){let e=XI();zi(0,"mat-year-view",5),og("activeDateChange",function(n){yd(e);let r=ew();return Fw(r.activeDate,n)||(r.activeDate=n),vd(n)}),jh("monthSelected",function(n){yd(e);let r=ew();return vd(r._monthSelectedInYearView(n))})("selectedChange",function(n){yd(e);let r=ew();return vd(r._goToDateInView(n,"month"))}),bu();}if(i&2){let e=ew();rg("activeDate",e.activeDate),Rh("selected",e.selected)("dateFilter",e.dateFilter)("maxDate",e.maxDate)("minDate",e.minDate)("dateClass",e.dateClass);}}function Ps(i,a){if(i&1){let e=XI();zi(0,"mat-multi-year-view",6),og("activeDateChange",function(n){yd(e);let r=ew();return Fw(r.activeDate,n)||(r.activeDate=n),vd(n)}),jh("yearSelected",function(n){yd(e);let r=ew();return vd(r._yearSelectedInMultiYearView(n))})("selectedChange",function(n){yd(e);let r=ew();return vd(r._goToDateInView(n,"year"))}),bu();}if(i&2){let e=ew();rg("activeDate",e.activeDate),Rh("selected",e.selected)("dateFilter",e.dateFilter)("maxDate",e.maxDate)("minDate",e.minDate)("dateClass",e.dateClass);}}function Ls(i,a){}var Ns=["button"],Vs=[[["","matDatepickerToggleIcon",""]]],Bs=["[matDatepickerToggleIcon]"];function zs(i,a){i&1&&(Ad(),zi(0,"svg",2),Oh(1,"path",3),bu());}var pt=(()=>{class i{changes=new re;calendarLabel="Calendar";openCalendarLabel="Open calendar";closeCalendarLabel="Close calendar";prevMonthLabel="Previous month";nextMonthLabel="Next month";prevYearLabel="Previous year";nextYearLabel="Next year";prevMultiYearLabel="Previous 24 years";nextMultiYearLabel="Next 24 years";switchToMonthViewLabel="Choose date";switchToMultiYearViewLabel="Choose month and year";startDateLabel="Start date";endDateLabel="End date";comparisonDateLabel="Comparison range";formatYearRange(e,t){return `${e} \u2013 ${t}`}formatYearRangeLabel(e,t){return `${e} to ${t}`}static \u0275fac=function(t){return new(t||i)};static \u0275prov=We$1({token:i,factory:i.\u0275fac})}return i})(),Hs=0,Pt=class{value;displayValue;ariaLabel;enabled;compareValue;rawValue;id=Hs++;cssClasses;constructor(a,e,t,n,r,o=a,l){this.value=a,this.displayValue=e,this.ariaLabel=t,this.enabled=n,this.compareValue=o,this.rawValue=l,this.cssClasses=r instanceof Set?Array.from(r):r;}},Ys={passive:false,capture:true},Cn={passive:true,capture:true},Pr={passive:true},ht=(()=>{class i{_elementRef=y(qn$1);_ngZone=y(te);_platform=y(C);_intl=y(pt);_eventCleanups;_skipNextFocus=false;_focusActiveCellAfterViewChecked=false;label;rows;todayValue;startValue;endValue;labelMinRequiredCells;numCols=7;activeCell=0;ngAfterViewChecked(){this._focusActiveCellAfterViewChecked&&(this._focusActiveCell(),this._focusActiveCellAfterViewChecked=false);}isRange=false;cellAspectRatio=1;comparisonStart=null;comparisonEnd=null;previewStart=null;previewEnd=null;startDateAccessibleName=null;endDateAccessibleName=null;selectedValueChange=new Xe;previewChange=new Xe;activeDateChange=new Xe;dragStarted=new Xe;dragEnded=new Xe;_firstRowOffset;_cellPadding;_cellWidth;_startDateLabelId;_endDateLabelId;_comparisonStartDateLabelId;_comparisonEndDateLabelId;_didDragSinceMouseDown=false;_injector=y(he);comparisonDateAccessibleName=this._intl.comparisonDateLabel;_trackRow=e=>e;constructor(){let e=y(Kp),t=y(ce);this._startDateLabelId=t.getId("mat-calendar-body-start-"),this._endDateLabelId=t.getId("mat-calendar-body-end-"),this._comparisonStartDateLabelId=t.getId("mat-calendar-body-comparison-start-"),this._comparisonEndDateLabelId=t.getId("mat-calendar-body-comparison-end-"),y(ct$1).load(an),this._ngZone.runOutsideAngular(()=>{let n=this._elementRef.nativeElement,r=[e.listen(n,"touchmove",this._touchmoveHandler,Ys),e.listen(n,"mouseenter",this._enterHandler,Cn),e.listen(n,"focus",this._enterHandler,Cn),e.listen(n,"mouseleave",this._leaveHandler,Cn),e.listen(n,"blur",this._leaveHandler,Cn),e.listen(n,"mousedown",this._mousedownHandler,Pr),e.listen(n,"touchstart",this._mousedownHandler,Pr)];this._platform.isBrowser&&r.push(e.listen("window","mouseup",this._mouseupHandler),e.listen("window","touchend",this._touchendHandler)),this._eventCleanups=r;});}_cellClicked(e,t){this._didDragSinceMouseDown||e.enabled&&this.selectedValueChange.emit({value:e.value,event:t});}_emitActiveDateChange(e,t){e.enabled&&this.activeDateChange.emit({value:e.value,event:t});}_isSelected(e){return this.startValue===e||this.endValue===e}ngOnChanges(e){let t=e.numCols,{rows:n,numCols:r}=this;(e.rows||t)&&(this._firstRowOffset=n&&n.length&&n[0].length?r-n[0].length:0),(e.cellAspectRatio||t||!this._cellPadding)&&(this._cellPadding=`${50*this.cellAspectRatio/r}%`),(t||!this._cellWidth)&&(this._cellWidth=`${100/r}%`);}ngOnDestroy(){this._eventCleanups.forEach(e=>e());}_isActiveCell(e,t){let n=e*this.numCols+t;return e&&(n-=this._firstRowOffset),n==this.activeCell}_focusActiveCell(e=true){eD(()=>{setTimeout(()=>{let t=this._elementRef.nativeElement.querySelector(".mat-calendar-body-active");t&&(e||(this._skipNextFocus=true),t.focus());});},{injector:this._injector});}_scheduleFocusActiveCellAfterViewChecked(){this._focusActiveCellAfterViewChecked=true;}_isRangeStart(e){return Ti(e,this.startValue,this.endValue)}_isRangeEnd(e){return Oi(e,this.startValue,this.endValue)}_isInRange(e){return Fi(e,this.startValue,this.endValue,this.isRange)}_isComparisonStart(e){return Ti(e,this.comparisonStart,this.comparisonEnd)}_isComparisonBridgeStart(e,t,n){if(!this._isComparisonStart(e)||this._isRangeStart(e)||!this._isInRange(e))return  false;let r=this.rows[t][n-1];if(!r){let o=this.rows[t-1];r=o&&o[o.length-1];}return r&&!this._isRangeEnd(r.compareValue)}_isComparisonBridgeEnd(e,t,n){if(!this._isComparisonEnd(e)||this._isRangeEnd(e)||!this._isInRange(e))return  false;let r=this.rows[t][n+1];if(!r){let o=this.rows[t+1];r=o&&o[0];}return r&&!this._isRangeStart(r.compareValue)}_isComparisonEnd(e){return Oi(e,this.comparisonStart,this.comparisonEnd)}_isInComparisonRange(e){return Fi(e,this.comparisonStart,this.comparisonEnd,this.isRange)}_isComparisonIdentical(e){return this.comparisonStart===this.comparisonEnd&&e===this.comparisonStart}_isPreviewStart(e){return Ti(e,this.previewStart,this.previewEnd)}_isPreviewEnd(e){return Oi(e,this.previewStart,this.previewEnd)}_isInPreview(e){return Fi(e,this.previewStart,this.previewEnd,this.isRange)}_getDescribedby(e){if(!this.isRange)return null;if(this.startValue===e&&this.endValue===e)return `${this._startDateLabelId} ${this._endDateLabelId}`;if(this.startValue===e)return this._startDateLabelId;if(this.endValue===e)return this._endDateLabelId;if(this.comparisonStart!==null&&this.comparisonEnd!==null){if(e===this.comparisonStart&&e===this.comparisonEnd)return `${this._comparisonStartDateLabelId} ${this._comparisonEndDateLabelId}`;if(e===this.comparisonStart)return this._comparisonStartDateLabelId;if(e===this.comparisonEnd)return this._comparisonEndDateLabelId}return null}_enterHandler=e=>{if(this._skipNextFocus&&e.type==="focus"){this._skipNextFocus=false;return}if(e.target&&this.isRange){let t=this._getCellFromElement(e.target);t&&this._ngZone.run(()=>this.previewChange.emit({value:t.enabled?t:null,event:e}));}};_touchmoveHandler=e=>{if(!this.isRange)return;let t=Lr(e),n=t?this._getCellFromElement(t):null;t!==e.target&&(this._didDragSinceMouseDown=true),Ri(e.target)&&e.preventDefault(),this._ngZone.run(()=>this.previewChange.emit({value:n?.enabled?n:null,event:e}));};_leaveHandler=e=>{this.previewEnd!==null&&this.isRange&&(e.type!=="blur"&&(this._didDragSinceMouseDown=true),e.target&&this._getCellFromElement(e.target)&&!(e.relatedTarget&&this._getCellFromElement(e.relatedTarget))&&this._ngZone.run(()=>this.previewChange.emit({value:null,event:e})));};_mousedownHandler=e=>{if(!this.isRange)return;this._didDragSinceMouseDown=false;let t=e.target&&this._getCellFromElement(e.target);!t||!this._isInRange(t.compareValue)||this._ngZone.run(()=>{this.dragStarted.emit({value:t.rawValue,event:e});});};_mouseupHandler=e=>{if(!this.isRange)return;let t=Ri(e.target);if(!t){this._ngZone.run(()=>{this.dragEnded.emit({value:null,event:e});});return}t.closest(".mat-calendar-body")===this._elementRef.nativeElement&&this._ngZone.run(()=>{let n=this._getCellFromElement(t);this.dragEnded.emit({value:n?.rawValue??null,event:e});});};_touchendHandler=e=>{let t=Lr(e);t&&this._mouseupHandler({target:t});};_getCellFromElement(e){let t=Ri(e);if(t){let n=t.getAttribute("data-mat-row"),r=t.getAttribute("data-mat-col");if(n&&r)return this.rows[parseInt(n)]?.[parseInt(r)]||null}return null}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["","mat-calendar-body",""]],hostAttrs:[1,"mat-calendar-body"],inputs:{label:"label",rows:"rows",todayValue:"todayValue",startValue:"startValue",endValue:"endValue",labelMinRequiredCells:"labelMinRequiredCells",numCols:"numCols",activeCell:"activeCell",isRange:"isRange",cellAspectRatio:"cellAspectRatio",comparisonStart:"comparisonStart",comparisonEnd:"comparisonEnd",previewStart:"previewStart",previewEnd:"previewEnd",startDateAccessibleName:"startDateAccessibleName",endDateAccessibleName:"endDateAccessibleName"},outputs:{selectedValueChange:"selectedValueChange",previewChange:"previewChange",activeDateChange:"activeDateChange",dragStarted:"dragStarted",dragEnded:"dragEnded"},exportAs:["matCalendarBody"],features:[Oc],decls:11,vars:11,consts:[["aria-hidden","true"],["role","row"],[1,"mat-calendar-body-hidden-label",3,"id"],[1,"mat-calendar-body-label"],[1,"mat-calendar-body-label",3,"paddingTop","paddingBottom"],["role","gridcell",1,"mat-calendar-body-cell-container",3,"width","paddingTop","paddingBottom"],["role","gridcell",1,"mat-calendar-body-cell-container"],["type","button",1,"mat-calendar-body-cell",3,"click","focus","tabindex"],[1,"mat-calendar-body-cell-content","mat-focus-indicator"],["aria-hidden","true",1,"mat-calendar-body-cell-preview"]],template:function(t,n){t&1&&($I(0,Ms,3,6,"tr",0),WI(1,As,4,1,"tr",1,Es,true),_u(3,"span",2),Aw(4),Su(),_u(5,"span",2),Aw(6),Su(),_u(7,"span",2),Aw(8),Su(),_u(9,"span",2),Aw(10),Su()),t&2&&(zI(n._firstRowOffset<n.labelMinRequiredCells?0:-1),TD(),qI(n.rows),TD(2),Ph("id",n._startDateLabelId),TD(),Mu(" ",n.startDateAccessibleName,`
`),TD(),Ph("id",n._endDateLabelId),TD(),Mu(" ",n.endDateAccessibleName,`
`),TD(),Ph("id",n._comparisonStartDateLabelId),TD(),tg(" ",n.comparisonDateAccessibleName," ",n.startDateAccessibleName,`
`),TD(),Ph("id",n._comparisonEndDateLabelId),TD(),tg(" ",n.comparisonDateAccessibleName," ",n.endDateAccessibleName,`
...
`],encapsulation:2})}return i})(),Xs=new C$1("mat-datepicker-scroll-strategy",{providedIn:"root",factory:()=>{let i=y(he);return ()=>st(i)}}),Gr=(()=>{class i{_elementRef=y(qn$1);_animationsDisabled=ve();_changeDetectorRef=y(DC);_globalModel=y(Lt);_dateAdapter=y(ie);_ngZone=y(te);_rangeSelectionStrategy=y(jr,{optional:true});_stateChanges;_model;_eventCleanups;_animationFallback;_calendar;color;datepicker;comparisonStart=null;comparisonEnd=null;startDateAccessibleName=null;endDateAccessibleName=null;_isAbove=false;_animationDone=new re;_isAnimating=false;_closeButtonText;_closeButtonFocused=false;_actionsPortal=null;_dialogLabelId=null;constructor(){if(y(ct$1).load(yt),this._closeButtonText=y(pt).closeCalendarLabel,!this._animationsDisabled){let e=this._elementRef.nativeElement,t=y(Kp);this._eventCleanups=this._ngZone.runOutsideAngular(()=>[t.listen(e,"animationstart",this._handleAnimationEvent),t.listen(e,"animationend",this._handleAnimationEvent),t.listen(e,"animationcancel",this._handleAnimationEvent)]);}}ngAfterViewInit(){this._stateChanges=this.datepicker.stateChanges.subscribe(()=>{this._changeDetectorRef.markForCheck();}),this._calendar.focusActiveCell();}ngOnDestroy(){clearTimeout(this._animationFallback),this._eventCleanups?.forEach(e=>e()),this._stateChanges?.unsubscribe(),this._animationDone.complete();}_handleUserSelection(e){let t=this._model.selection,n=e.value,r=t instanceof xe;if(r&&this._rangeSelectionStrategy){let o=this._rangeSelectionStrategy.selectionFinished(n,t,e.event);this._model.updateSelection(o,this);}else n&&(r||!this._dateAdapter.sameDate(n,t))&&this._model.add(n);(!this._model||this._model.isComplete())&&!this._actionsPortal&&this.datepicker.close();}_handleUserDragDrop(e){this._model.updateSelection(e.value,this);}_startExitAnimation(){this._elementRef.nativeElement.classList.add("mat-datepicker-content-exit"),this._animationsDisabled?this._animationDone.next():(clearTimeout(this._animationFallback),this._animationFallback=setTimeout(()=>{this._isAnimating||this._animationDone.next();},200));}_handleAnimationEvent=e=>{let t=this._elementRef.nativeElement;e.target!==t||!e.animationName.startsWith("_mat-datepicker-content")||(clearTimeout(this._animationFallback),this._isAnimating=e.type==="animationstart",t.classList.toggle("mat-datepicker-content-animating",this._isAnimating),this._isAnimating||this._animationDone.next());};_getSelected(){return this._model.selection}_applyPendingSelection(){this._model!==this._globalModel&&this._globalModel.updateSelection(this._model.selection,this);}_assignActions(e,t){this._model=e?this._globalModel.clone():this._globalModel,this._actionsPortal=e,t&&this._changeDetectorRef.detectChanges();}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["mat-datepicker-content"]],viewQuery:function(t,n){if(t&1&&Uh(Li,5),t&2){let r;iw(r=sw())&&(n._calendar=r.first);}},hostAttrs:[1,"mat-datepicker-content"],hostVars:6,hostBindings:function(t,n){t&2&&(Dw(n.color?"mat-"+n.color:""),Zh("mat-datepicker-content-touch",n.datepicker.touchUi)("mat-datepicker-content-animations-enabled",!n._animationsDisabled));},inputs:{color:"color"},exportAs:["matDatepickerContent"],decls:5,vars:26,consts:[["cdkTrapFocus","","role","dialog",1,"mat-datepicker-content-container"],[3,"yearSelected","monthSelected","viewChanged","_userSelection","_userDragDrop","id","startAt","startView","minDate","maxDate","dateFilter","headerComponent","selected","dateClass","comparisonStart","comparisonEnd","startDateAccessibleName","endDateAccessibleName"],[3,"cdkPortalOutlet"],["type","button","matButton","elevated",1,"mat-datepicker-close-button",3,"focus","blur","click","color"]],template:function(t,n){t&1&&(zi(0,"div",0)(1,"mat-calendar",1),jh("yearSelected",function(o){return n.datepicker._selectYear(o)})("monthSelected",function(o){return n.datepicker._selectMonth(o)})("viewChanged",function(o){return n.datepicker._viewChanged(o)})("_userSelection",function(o){return n._handleUserSelection(o)})("_userDragDrop",function(o){return n._handleUserDragDrop(o)}),bu(),Ch(2,Ls,0,0,"ng-template",2),zi(3,"button",3),jh("focus",function(){return n._closeButtonFocused=true})("blur",function(){return n._closeButtonFocused=false})("click",function(){return n.datepicker.close()}),Aw(4),bu()()),t&2&&(Zh("mat-datepicker-content-container-with-custom-header",n.datepicker.calendarHeaderComponent)("mat-datepicker-content-container-with-actions",n._actionsPortal),xh("aria-modal",true)("aria-labelledby",n._dialogLabelId??void 0),TD(),Dw(n.datepicker.panelClass),Rh("id",n.datepicker.id)("startAt",n.datepicker.startAt)("startView",n.datepicker.startView)("minDate",n.datepicker._getMinDate())("maxDate",n.datepicker._getMaxDate())("dateFilter",n.datepicker._getDateFilter())("headerComponent",n.datepicker.calendarHeaderComponent)("selected",n._getSelected())("dateClass",n.datepicker.dateClass)("comparisonStart",n.comparisonStart)("comparisonEnd",n.comparisonEnd)("startDateAccessibleName",n.startDateAccessibleName)("endDateAccessibleName",n.endDateAccessibleName),TD(),Rh("cdkPortalOutlet",n._actionsPortal),TD(),Zh("cdk-visually-hidden",!n._closeButtonFocused),Rh("color",n.color||"primary"),TD(),eg(n._closeButtonText));},dependencies:[ni,Li,gi,Di],styles:[`@keyframes _mat-datepicker-content-dropdown-enter {
  from {
    opacity: 0;
...
`],encapsulation:2})}return i})();var qr=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=rs$1({type:i});static \u0275inj=Ir$1({providers:[pt],imports:[br,xi,ii,dn,Gr,Bi,Xr,st$1,kt]})}return i})();var Vt=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=rs$1({type:i});static \u0275inj=Ir$1({imports:[Jt,Dn,st$1]})}return i})();var el=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=eI({type:i,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(t,n){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
...
`],encapsulation:2})}return i})(),tl={passive:true},Kr=(()=>{class i{_platform=y(C);_ngZone=y(te);_renderer=y(ln$1).createRenderer(null,null);_styleLoader=y(ct$1);_monitoredElements=new Map;monitor(e){if(!this._platform.isBrowser)return Lt$1;this._styleLoader.load(el);let t=fe(e),n=this._monitoredElements.get(t);if(n)return n.subject;let r=new re,o="cdk-text-field-autofilled",l=p=>{p.animationName==="cdk-text-field-autofill-start"&&!t.classList.contains(o)?(t.classList.add(o),this._ngZone.run(()=>r.next({target:p.target,isAutofilled:true}))):p.animationName==="cdk-text-field-autofill-end"&&t.classList.contains(o)&&(t.classList.remove(o),this._ngZone.run(()=>r.next({target:p.target,isAutofilled:false})));},c=this._ngZone.runOutsideAngular(()=>(t.classList.add("cdk-text-field-autofill-monitored"),this._renderer.listen(t,"animationstart",l,tl)));return this._monitoredElements.set(t,{subject:r,unlisten:c}),r}stopMonitoring(e){let t=fe(e),n=this._monitoredElements.get(t);n&&(n.unlisten(),n.subject.complete(),t.classList.remove("cdk-text-field-autofill-monitored"),t.classList.remove("cdk-text-field-autofilled"),this._monitoredElements.delete(t));}ngOnDestroy(){this._monitoredElements.forEach((e,t)=>this.stopMonitoring(t));}static \u0275fac=function(t){return new(t||i)};static \u0275prov=We$1({token:i,factory:i.\u0275fac})}return i})();var $r=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=rs$1({type:i});static \u0275inj=Ir$1({})}return i})();var nl=["button","checkbox","file","hidden","image","radio","range","reset","submit"],il=new C$1("MAT_INPUT_CONFIG"),Qr=(()=>{class i{_elementRef=y(qn$1);_platform=y(C);ngControl=y(N,{optional:true,self:true});_autofillMonitor=y(Kr);_ngZone=y(te);_formField=y(Ot,{optional:true});_renderer=y(Kp);_uid=y(ce).getId("mat-input-");_previousNativeValue;_inputValueAccessor;_signalBasedValueAccessor;_previousPlaceholder=null;_errorStateTracker;_config=y(il,{optional:true});_cleanupIosKeyup;_cleanupWebkitWheel;_isServer=false;_isNativeSelect=false;_isTextarea=false;_isInFormField=false;focused=false;stateChanges=new re;controlType="mat-input";autofilled=false;get disabled(){return this._disabled}set disabled(e){this._disabled=Re(e),this.focused&&(this.focused=false,this.stateChanges.next());}_disabled=false;get id(){return this._id}set id(e){this._id=e||this._uid;}_id;placeholder;name;get required(){return this._required??this.ngControl?.control?.hasValidator(le.required)??false}set required(e){this._required=Re(e);}_required;get type(){return this._type}set type(e){this._type=e||"text",this._validateType(),!this._isTextarea&&si().has(this._type)&&(this._elementRef.nativeElement.type=this._type);}_type="text";get errorStateMatcher(){return this._errorStateTracker.matcher}set errorStateMatcher(e){this._errorStateTracker.matcher=e;}userAriaDescribedBy;get value(){return this._signalBasedValueAccessor?this._signalBasedValueAccessor.value():this._inputValueAccessor.value}set value(e){e!==this.value&&(this._signalBasedValueAccessor?this._signalBasedValueAccessor.value.set(e):this._inputValueAccessor.value=e,this.stateChanges.next());}get readonly(){return this._readonly}set readonly(e){this._readonly=Re(e);}_readonly=false;disabledInteractive;get errorState(){return this._errorStateTracker.errorState}set errorState(e){this._errorStateTracker.errorState=e;}_neverEmptyInputTypes=["date","datetime","datetime-local","month","time","week"].filter(e=>si().has(e));constructor(){let e=y(qt,{optional:true}),t=y(Qt$1,{optional:true}),n=y(ba),r=y(yn,{optional:true,self:true}),o=this._elementRef.nativeElement,l=o.nodeName.toLowerCase();r?Pr$1(r.value)?this._signalBasedValueAccessor=r:this._inputValueAccessor=r:this._inputValueAccessor=o,this._previousNativeValue=this.value,this.id=this.id,this._platform.IOS&&this._ngZone.runOutsideAngular(()=>{this._cleanupIosKeyup=this._renderer.listen(o,"keyup",this._iOSKeyupListener);}),this._errorStateTracker=new on(n,this.ngControl,t,e,this.stateChanges),this._isServer=!this._platform.isBrowser,this._isNativeSelect=l==="select",this._isTextarea=l==="textarea",this._isInFormField=!!this._formField,this.disabledInteractive=this._config?.disabledInteractive||false,this._isNativeSelect&&(this.controlType=o.multiple?"mat-native-select-multiple":"mat-native-select"),this._signalBasedValueAccessor&&jd(()=>{this._signalBasedValueAccessor.value(),this.stateChanges.next();});}ngAfterViewInit(){this._platform.isBrowser&&this._autofillMonitor.monitor(this._elementRef.nativeElement).subscribe(e=>{this.autofilled=e.isAutofilled,this.stateChanges.next();});}ngOnChanges(){this.stateChanges.next();}ngOnDestroy(){this.stateChanges.complete(),this._platform.isBrowser&&this._autofillMonitor.stopMonitoring(this._elementRef.nativeElement),this._cleanupIosKeyup?.(),this._cleanupWebkitWheel?.();}ngDoCheck(){this.ngControl&&(this.updateErrorState(),this.ngControl.disabled!==null&&this.ngControl.disabled!==this.disabled&&(this.disabled=this.ngControl.disabled,this.stateChanges.next())),this._dirtyCheckNativeValue(),this._dirtyCheckPlaceholder();}focus(e){this._elementRef.nativeElement.focus(e);}updateErrorState(){this._errorStateTracker.updateErrorState();}_focusChanged(e){if(e!==this.focused){if(!this._isNativeSelect&&e&&this.disabled&&this.disabledInteractive){let t=this._elementRef.nativeElement;t.type==="number"?(t.type="text",t.setSelectionRange(0,0),t.type="number"):t.setSelectionRange(0,0);}this.focused=e,this.stateChanges.next();}}_onInput(){}_dirtyCheckNativeValue(){let e=this._elementRef.nativeElement.value;this._previousNativeValue!==e&&(this._previousNativeValue=e,this.stateChanges.next());}_dirtyCheckPlaceholder(){let e=this._getPlaceholder();if(e!==this._previousPlaceholder){let t=this._elementRef.nativeElement;this._previousPlaceholder=e,e?t.setAttribute("placeholder",e):t.removeAttribute("placeholder");}}_getPlaceholder(){return this.placeholder||null}_validateType(){nl.indexOf(this._type)>-1;}_isNeverEmpty(){return this._neverEmptyInputTypes.indexOf(this._type)>-1}_isBadInput(){let e=this._elementRef.nativeElement.validity;return e&&e.badInput}get empty(){return !this._isNeverEmpty()&&!this._elementRef.nativeElement.value&&!this._isBadInput()&&!this.autofilled}get shouldLabelFloat(){if(this._isNativeSelect){let e=this._elementRef.nativeElement,t=e.options[0];return this.focused||e.multiple||!this.empty||!!(e.selectedIndex>-1&&t&&t.label)}else return this.focused&&!this.disabled||!this.empty}get describedByIds(){return this._elementRef.nativeElement.getAttribute("aria-describedby")?.split(" ")||[]}setDescribedByIds(e){let t=this._elementRef.nativeElement;e.length?t.setAttribute("aria-describedby",e.join(" ")):t.removeAttribute("aria-describedby");}onContainerClick(){this.focused||this.focus();}_isInlineSelect(){let e=this._elementRef.nativeElement;return this._isNativeSelect&&(e.multiple||e.size>1)}_iOSKeyupListener=e=>{let t=e.target;!t.value&&t.selectionStart===0&&t.selectionEnd===0&&(t.setSelectionRange(1,1),t.setSelectionRange(0,0));};_getReadonlyAttribute(){return this._isNativeSelect?null:this.readonly||this.disabled&&this.disabledInteractive?"true":null}static \u0275fac=function(t){return new(t||i)};static \u0275dir=Du({type:i,selectors:[["input","matInput",""],["textarea","matInput",""],["select","matNativeControl",""],["input","matNativeControl",""],["textarea","matNativeControl",""]],hostAttrs:[1,"mat-mdc-input-element"],hostVars:21,hostBindings:function(t,n){t&1&&jh("focus",function(){return n._focusChanged(true)})("blur",function(){return n._focusChanged(false)})("input",function(){return n._onInput()}),t&2&&(Ph("id",n.id)("disabled",n.disabled&&!n.disabledInteractive)("required",n.required),xh("name",n.name||null)("readonly",n._getReadonlyAttribute())("aria-disabled",n.disabled&&n.disabledInteractive?"true":null)("aria-invalid",n.empty&&n.required?null:n.errorState)("aria-required",n.required)("id",n.id),Zh("mat-input-server",n._isServer)("mat-mdc-form-field-textarea-control",n._isInFormField&&n._isTextarea)("mat-mdc-form-field-input-control",n._isInFormField)("mat-mdc-input-disabled-interactive",n.disabledInteractive)("mdc-text-field__input",n._isInFormField)("mat-mdc-native-select-inline",n._isInlineSelect()));},inputs:{disabled:"disabled",id:"id",placeholder:"placeholder",name:"name",required:"required",type:"type",errorStateMatcher:"errorStateMatcher",userAriaDescribedBy:[0,"aria-describedby","userAriaDescribedBy"],value:"value",readonly:"readonly",disabledInteractive:[2,"disabledInteractive","disabledInteractive",ML]},exportAs:["matInput"],features:[Bw([{provide:wn,useExisting:i}]),Oc]})}return i})(),Jr=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=rs$1({type:i});static \u0275inj=Ir$1({imports:[Vt,Vt,$r,st$1]})}return i})();var rl=()=>["Aprobada","Rechazada","Mas plazo"],to=(i,a)=>a.kind;function ol(i,a){if(i&1){let e=XI();zi(0,"button",20),jh("click",function(){let n=yd(e).$implicit,r=ew(2);return vd(r.selectResolution(n))}),Aw(1),bu();}if(i&2){let e=a.$implicit,t=ew(2);Zh("bg-white",t.transitionModel().resolution===e)("text-[#203f75]",t.transitionModel().resolution===e)("shadow-sm",t.transitionModel().resolution===e)("text-slate-500",t.transitionModel().resolution!==e)("opacity-40",e==="Mas plazo"&&t.isFollowUpExpired())("cursor-not-allowed",e==="Mas plazo"&&t.isFollowUpExpired()),Rh("disabled",e==="Mas plazo"&&t.isFollowUpExpired()),TD(),Mu(" ",e==="Mas plazo"?"M\xE1s plazo":e," ");}}function sl(i,a){i&1&&(zi(0,"p",19),Aw(1," El plazo m\xE1ximo ya venci\xF3; solo puede cerrar el seguimiento. "),bu());}function ll(i,a){if(i&1&&(zi(0,"fieldset")(1,"legend",16),Aw(2,"Resoluci\xF3n"),bu(),zi(3,"div",17),WI(4,ol,2,14,"button",18,GI),bu(),$I(6,sl,2,0,"p",19),bu()),i&2){let e=ew();TD(4),qI(Vw(1,rl)),TD(2),zI(e.isFollowUpExpired()?6:-1);}}function dl(i,a){if(i&1&&(zi(0,"p",29),Aw(1),bu()),i&2){let e=a.$implicit;TD(),eg(e.message);}}function cl(i,a){if(i&1&&WI(0,dl,2,1,"p",29,to),i&2){let e=ew(2);qI(e.transitionForm.estimatedDate().errors());}}function ml(i,a){if(i&1){let e=XI();zi(0,"div")(1,"span",21),Aw(2),bu(),zi(3,"mat-form-field",22)(4,"mat-icon",23),Aw(5,"event"),bu(),zi(6,"input",24),jh("click",function(){yd(e);let n=cw(9);return vd(n.open())}),bu(),fE(),Oh(7,"mat-datepicker-toggle",25)(8,"mat-datepicker",26,0),bu(),$I(10,cl,2,0),zi(11,"p",27)(12,"mat-icon",28),Aw(13,"touch_app"),bu(),Aw(14," Toque el campo para elegir el limite de seguimiento "),bu()();}if(i&2){let e=cw(9),t=ew();TD(2),Mu(" ",t.dateLabel()," "),TD(4),Rh("matDatepicker",e)("max",t.maximumDate())("formField",t.transitionForm.estimatedDate),hE(),TD(),Rh("for",e),TD(3),zI(t.transitionForm.estimatedDate().touched()&&t.transitionForm.estimatedDate().invalid()?10:-1);}}function ul(i,a){if(i&1&&(zi(0,"p",8)(1,"mat-icon",30),Aw(2,"event_available"),bu(),Aw(3),bu()),i&2){let e=ew();TD(3),Mu(" ",e.automaticDateMessage()," ");}}function hl(i,a){i&1&&(zi(0,"span",11),Aw(1,"*"),bu());}function pl(i,a){if(i&1&&(zi(0,"p",29),Aw(1),bu()),i&2){let e=a.$implicit;TD(),eg(e.message);}}function fl(i,a){if(i&1&&WI(0,pl,2,1,"p",29,to),i&2){let e=ew();qI(e.transitionForm.observation().errors());}}var eo=class i{item=TL.required();supply=TL.required();closed=CL();confirmed=CL();transitionModel=pi({estimatedDate:null,observation:"",resolution:"Aprobada"});isEvaluation=Zw(()=>this.item().status==="Entregado");requiresDate=Zw(()=>!this.isEvaluation()||this.transitionModel().resolution==="Mas plazo");requiresObservation=Zw(()=>this.isEvaluation()&&this.transitionModel().resolution!=="Mas plazo");followUpHardLimitDate=Zw(()=>{let a=this.parseDisplayDate(this.item().deliveredAt);return a?this.addDays(a,15):null});isFollowUpExpired=Zw(()=>{let a=this.minimumDateOrNull(this.parseDisplayDate(this.item().followUpMaxAt),this.followUpHardLimitDate());return !!(a&&this.isOverdue(a))});transitionForm=xt(this.transitionModel,a=>{Kr$1(a.estimatedDate,{message:"Seleccione una fecha.",when:()=>this.requiresDate()}),Kr$1(a.observation,{message:"Agregue una observacion para cerrar el seguimiento.",when:()=>this.requiresObservation()});});title=Zw(()=>({Pedido:"Marcar muestra como enviada",Enviado:"Confirmar recepcion",Recibido:"Confirmar entrega",Entregado:"Evaluar muestra",Aprobada:"Muestra aprobada",Rechazada:"Muestra rechazada"})[this.item().status]);dateLabel=Zw(()=>this.item().status==="Pedido"?"Fecha estimada de recepcion":this.item().status==="Enviado"?"Fecha de visita al cliente":"Fecha limite de seguimiento");maximumDate=Zw(()=>this.maximumAllowedDate());automaticDateMessage=Zw(()=>this.item().status==="Entregado"&&this.isFollowUpExpired()?"El plazo maximo ya fue superado. Para finalizar el seguimiento, registre si la muestra fue aprobada o rechazada.":{Pedido:"La fecha del pedido se registro automaticamente al crearlo.",Enviado:"La fecha de recepcion se registrara automaticamente al confirmar.",Recibido:"La entrega se registra hoy automaticamente. Esta fecha define el plazo limite para evaluar la muestra.",Entregado:"El plazo puede extenderse hasta un maximo de 15 dias. El feedback quedara guardado en el historial.",Aprobada:"",Rechazada:""}[this.item().status]);ngOnInit(){this.item().status==="Recibido"&&this.transitionForm.estimatedDate().value.set(this.addDays(new Date,15));}selectResolution(a){if(a==="Mas plazo"&&this.isFollowUpExpired()||(this.transitionForm.resolution().value.set(a),a!=="Mas plazo"))return;let e=this.parseDisplayDate(this.item().followUpMaxAt),t=e&&e.getTime()>Date.now()?e:new Date;this.transitionForm.estimatedDate().value.set(this.clampFollowUpDate(this.addDays(t,5)));}submit(){if(this.transitionForm().invalid())return;let a=this.transitionModel();this.confirmed.emit({estimatedDate:this.toInputDate(a.estimatedDate),observation:a.observation.trim(),resolution:this.isEvaluation()?a.resolution:void 0});}parseDisplayDate(a){if(!a)return null;let[e,t,n]=a.split("/").map(Number);return new Date(n,t-1,e)}addDays(a,e){let t=new Date(a.getFullYear(),a.getMonth(),a.getDate());return t.setDate(t.getDate()+e),t}maximumAllowedDate(){return this.item().status==="Recibido"?this.addDays(new Date,15):this.item().status==="Entregado"&&this.transitionModel().resolution==="Mas plazo"?this.followUpHardLimitDate():null}clampFollowUpDate(a){let e=this.followUpHardLimitDate();return e?this.minimumDate(a,e):a}minimumDate(a,e){return a.getTime()<=e.getTime()?a:e}minimumDateOrNull(a,e){return a?e?this.minimumDate(a,e):a:e}isOverdue(a){return new Date(a.getFullYear(),a.getMonth(),a.getDate(),23,59,59,999).getTime()<Date.now()}toInputDate(a){if(!a)return "";let e=new Date(a.getFullYear(),a.getMonth(),a.getDate()),t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return `${t}-${n}-${r}`}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=eI({type:i,selectors:[["app-sample-transition-dialog"]],inputs:{item:[1,"item"],supply:[1,"supply"]},outputs:{closed:"closed",confirmed:"confirmed"},features:[Bw([{provide:wt,useValue:"es-AR"},Qa()])],decls:25,vars:11,consts:[["datePicker",""],[1,"mc-dialog","overflow-hidden","rounded-lg","bg-white","text-[#082653]","shadow-2xl"],[1,"flex","items-start","justify-between","border-b","border-slate-200","px-5","py-4"],[1,"min-w-0","pr-3"],[1,"text-lg","font-black"],[1,"mt-1","truncate","text-sm","text-slate-500"],["type","button","aria-label","Cerrar",1,"flex","size-9","shrink-0","items-center","justify-center","rounded-md","text-slate-400","transition","hover:bg-slate-100","hover:text-slate-700",3,"click"],[1,"space-y-4","px-5","py-5"],[1,"flex","items-start","gap-2","rounded-md","border","border-blue-100","bg-blue-50","px-3","py-2","text-xs","font-medium","text-blue-800"],[1,"block"],[1,"mb-1.5","block","text-xs","font-black","uppercase","text-slate-500"],[1,"text-red-600"],["rows","3",1,"w-full","resize-none","rounded-md","border","border-slate-200","px-3","py-2","text-sm","outline-none","transition","focus:border-[#45658f]",3,"placeholder","formField"],[1,"flex","justify-end","gap-3","border-t","border-slate-200","px-5","py-4"],["type","button",1,"h-10","rounded-md","border","border-slate-300","px-4","text-sm","font-bold","text-slate-600","transition","hover:bg-slate-50",3,"click"],["type","button",1,"h-10","rounded-md","bg-[#45658f]","px-5","text-sm","font-bold","text-white","transition","hover:bg-[#31547f]","disabled:cursor-not-allowed","disabled:opacity-50",3,"click","disabled"],[1,"mb-2","text-xs","font-black","uppercase","text-slate-500"],[1,"grid","grid-cols-3","rounded-md","bg-slate-100","p-1"],["type","button",1,"min-h-9","rounded","px-2","text-xs","font-bold","transition",3,"bg-white","text-[#203f75]","shadow-sm","text-slate-500","opacity-40","cursor-not-allowed","disabled"],[1,"mt-2","text-xs","font-medium","text-red-600"],["type","button",1,"min-h-9","rounded","px-2","text-xs","font-bold","transition",3,"click","disabled"],[1,"mb-2","block","text-xs","font-black","uppercase","text-slate-500"],["appearance","outline","subscriptSizing","dynamic",1,"mc-date-field","w-full"],["matPrefix",""],["matInput","","readonly","","placeholder","Seleccionar fecha",3,"click","matDatepicker","max","formField"],["matIconSuffix","",3,"for"],["panelClass","mc-date-picker","startView","month"],[1,"mt-1.5","flex","items-center","gap-1.5","text-[11px]","font-medium","text-slate-400"],[1,"!text-[15px]"],[1,"mt-1.5","text-xs","font-semibold","text-red-600"],[1,"!text-[17px]"]],template:function(e,t){e&1&&(zi(0,"section",1)(1,"header",2)(2,"div",3)(3,"h2",4),Aw(4),bu(),zi(5,"p",5),Aw(6),bu()(),zi(7,"button",6),jh("click",function(){return t.closed.emit()}),zi(8,"mat-icon"),Aw(9,"close"),bu()()(),zi(10,"div",7),$I(11,ll,7,2,"fieldset"),$I(12,ml,15,6,"div"),$I(13,ul,4,1,"p",8),zi(14,"label",9)(15,"span",10),Aw(16),$I(17,hl,2,0,"span",11),bu(),Oh(18,"textarea",12),fE(),$I(19,fl,2,0),bu()(),zi(20,"footer",13)(21,"button",14),jh("click",function(){return t.closed.emit()}),Aw(22," Cancelar "),bu(),zi(23,"button",15),jh("click",function(){return t.submit()}),Aw(24," Confirmar "),bu()()()),e&2&&(TD(4),eg(t.title()),TD(2),eg(t.supply().name),TD(5),zI(t.isEvaluation()?11:-1),TD(),zI(t.requiresDate()?12:-1),TD(),zI(t.automaticDateMessage()?13:-1),TD(3),Mu(" ",t.isEvaluation()?"Feedback del cliente":"Observaci\xF3n"," "),TD(),zI(t.requiresObservation()?17:-1),TD(),Rh("placeholder",t.requiresObservation()?"Describa el motivo de la resoluci\xF3n...":"Agregue un comentario sobre la gesti\xF3n...")("formField",t.transitionForm.observation),hE(),TD(),zI(t.transitionForm.observation().touched()&&t.transitionForm.observation().invalid()?19:-1),TD(4),Rh("disabled",t.transitionForm().invalid()));},dependencies:[jr$1,qr,Zr,An,Bi,Vt,Dn,Si,ki,Zt,Xt,Jr,Qr],encapsulation:2})};export{eo as SampleTransitionDialog};