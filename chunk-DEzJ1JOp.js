...
`],encapsulation:2})}return i})(),nn=class i{_target;_ngZone;_platform;_containerElement;_triggerElement=null;_isPointerDown=false;_activeRipples=new Map;_mostRecentTransientRipple=null;_lastTouchStartEvent;_pointerUpEventsRegistered=false;_containerRect=null;static _eventManager=new li;constructor(a,e,t,n,r){this._target=a,this._ngZone=e,this._platform=n,n.isBrowser&&(this._containerElement=pe(t)),r&&r.get(ct$1).load(xo);}fadeInRipple(a,e,t={}){let n=this._containerRect=this._containerRect||this._containerElement.getBoundingClientRect(),r=B$1(B$1({},kt),t.animation);t.centered&&(a=n.left+n.width/2,e=n.top+n.height/2);let o=t.radius||wo(a,e,n),l=a-n.left,c=e-n.top,p=r.enterDuration,m=document.createElement("div");m.classList.add("mat-ripple-element"),m.style.left=`${l-o}px`,m.style.top=`${c-o}px`,m.style.height=`${o*2}px`,m.style.width=`${o*2}px`,t.color!=null&&(m.style.backgroundColor=t.color),m.style.transitionDuration=`${p}ms`,this._containerElement.appendChild(m);let x=window.getComputedStyle(m),$=x.transitionProperty,q=x.transitionDuration,X=$==="none"||q==="0s"||q==="0s, 0s"||n.width===0&&n.height===0,j=new si(this,m,t,X);m.style.transform="scale3d(1, 1, 1)",j.state=ve.FADING_IN,t.persistent||(this._mostRecentTransientRipple=j);let Be=null;return !X&&(p||r.exitDuration)&&this._ngZone.runOutsideAngular(()=>{let Bi=()=>{Be&&(Be.fallbackTimer=null),clearTimeout(zi),this._finishRippleTransition(j);},Rn=()=>this._destroyRipple(j),zi=setTimeout(Rn,p+100);m.addEventListener("transitionend",Bi),m.addEventListener("transitioncancel",Rn),Be={onTransitionEnd:Bi,onTransitionCancel:Rn,fallbackTimer:zi};}),this._activeRipples.set(j,Be),(X||!p)&&this._finishRippleTransition(j),j}fadeOutRipple(a){if(a.state===ve.FADING_OUT||a.state===ve.HIDDEN)return;let e=a.element,t=B$1(B$1({},kt),a.config.animation);e.style.transitionDuration=`${t.exitDuration}ms`,e.style.opacity="0",a.state=ve.FADING_OUT,(a._animationForciblyDisabledThroughCss||!t.exitDuration)&&this._finishRippleTransition(a);}fadeOutAll(){this._getActiveRipples().forEach(a=>a.fadeOut());}fadeOutAllNonPersistent(){this._getActiveRipples().forEach(a=>{a.config.persistent||a.fadeOut();});}setupTriggerEvents(a){let e=pe(a);!this._platform.isBrowser||!e||e===this._triggerElement||(this._removeTriggerEvents(),this._triggerElement=e,Xa.forEach(t=>{i._eventManager.addHandler(this._ngZone,t,e,this);}));}handleEvent(a){a.type==="mousedown"?this._onMousedown(a):a.type==="touchstart"?this._onTouchStart(a):this._onPointerUp(),this._pointerUpEventsRegistered||(this._ngZone.runOutsideAngular(()=>{Ga.forEach(e=>{this._triggerElement.addEventListener(e,this,Ua);});}),this._pointerUpEventsRegistered=true);}_finishRippleTransition(a){a.state===ve.FADING_IN?this._startFadeOutTransition(a):a.state===ve.FADING_OUT&&this._destroyRipple(a);}_startFadeOutTransition(a){let e=a===this._mostRecentTransientRipple,{persistent:t}=a.config;a.state=ve.VISIBLE,!t&&(!e||!this._isPointerDown)&&a.fadeOut();}_destroyRipple(a){let e=this._activeRipples.get(a)??null;this._activeRipples.delete(a),this._activeRipples.size||(this._containerRect=null),a===this._mostRecentTransientRipple&&(this._mostRecentTransientRipple=null),a.state=ve.HIDDEN,e!==null&&(a.element.removeEventListener("transitionend",e.onTransitionEnd),a.element.removeEventListener("transitioncancel",e.onTransitionCancel),e.fallbackTimer!==null&&clearTimeout(e.fallbackTimer)),a.element.remove();}_onMousedown(a){let e=Dt(a),t=this._lastTouchStartEvent&&Date.now()<this._lastTouchStartEvent+yo;!this._target.rippleDisabled&&!e&&!t&&(this._isPointerDown=true,this.fadeInRipple(a.clientX,a.clientY,this._target.rippleConfig));}_onTouchStart(a){if(!this._target.rippleDisabled&&!Ct(a)){this._lastTouchStartEvent=Date.now(),this._isPointerDown=true;let e=a.changedTouches;if(e)for(let t=0;t<e.length;t++)this.fadeInRipple(e[t].clientX,e[t].clientY,this._target.rippleConfig);}}_onPointerUp(){this._isPointerDown&&(this._isPointerDown=false,this._getActiveRipples().forEach(a=>{let e=a.state===ve.VISIBLE||a.config.terminateOnPointerUp&&a.state===ve.FADING_IN;!a.config.persistent&&e&&a.fadeOut();}));}_getActiveRipples(){return Array.from(this._activeRipples.keys())}_removeTriggerEvents(){let a=this._triggerElement;a&&(Xa.forEach(e=>i._eventManager.removeHandler(e,a,this)),this._pointerUpEventsRegistered&&(Ga.forEach(e=>a.removeEventListener(e,this,Ua)),this._pointerUpEventsRegistered=false));}};function wo(i,a,e){let t=Math.max(Math.abs(i-e.left),Math.abs(i-e.right)),n=Math.max(Math.abs(a-e.top),Math.abs(a-e.bottom));return Math.sqrt(t*t+n*n)}var Za=new C$1("mat-ripple-global-options");var an=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=KE({type:i,selectors:[["structural-styles"]],decls:0,vars:0,template:function(t,n){},styles:[`.mat-focus-indicator {
  position: relative;
}
...
`],encapsulation:2})}return i})();var No=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]],[["","progressIndicator",""]]],Vo=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]","[progressIndicator]"];function Bo(i,a){i&1&&(Cu(0,"div",2),ew(1,3),Tu());}var gr=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),wi=(()=>{class i extends xi{get appearance(){return this._appearance}set appearance(e){this.setAppearance(e||this._config?.defaultAppearance||"text");}_appearance=null;constructor(){super();let e=zo(this._elementRef.nativeElement);e&&this.setAppearance(e);}setAppearance(e){if(e===this._appearance)return;let t=this._elementRef.nativeElement.classList,n=this._appearance?gr.get(this._appearance):null,r=gr.get(e);n&&t.remove(...n),t.add(...r),this._appearance=e;}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=KE({type:i,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[Eh],ngContentSelectors:Vo,decls:8,vars:5,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-mdc-button-progress-indicator-container"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(t,n){t&1&&(JI(No),Oh(0,"span",0),ew(1),Cu(2,"span",1),ew(3,1),Tu(),ew(4,2),VI(5,Bo,2,0,"div",2),Oh(6,"span",3)(7,"span",4)),t&2&&(qh("mdc-button__ripple",!n._isFab)("mdc-fab__ripple",n._isFab),wD(5),HI(n.showProgress()?5:-1));},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2})}return i})();var Kr=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=ns$1({type:i});static \u0275inj=Ir$1({providers:[pt],imports:[br,yi,ni,dn,Gr,Vi,Xr,st$1,Mt]})}return i})();var Vt=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=ns$1({type:i});static \u0275inj=Ir$1({imports:[Jt,Dn,st$1]})}return i})();var Js=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=KE({type:i,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(t,n){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
