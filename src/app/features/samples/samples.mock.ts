...
export const MOCK_CLIENTS: MockClient[] = [
  ...
  },
  {
    ...
    address: 'Estomba 571, Bahia Blanca',
  ...
  },
  {
    ...
    locality: 'BAHIA BLANCA',
    address: 'Lainez 2401, Bahia Blanca',
  ...
  },
  {
    ...
    locality: 'BAHIA BLANCA',
    address: 'Necochea 675, Bahia Blanca',
  ...
  },
  {
    ...
    locality: 'VIEDMA',
    address: 'Alvaro Barros 1150, Viedma',
...
export const MOCK_SUPPLIES: MockSupply[] = [
  {
    ...
    brand: 'PREFIX',
    description: 'Aguja esteril para procedimientos de anestesia espinal.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-2',
    name: 'BARBIJO / MASCARA KN95 ALTA EFICACIA',
    brand: 'MEDISPO',
    description: 'Mascara de proteccion respiratoria de alta eficiencia.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-3',
  ...
  },
  {
    ...
    brand: 'MEDISPO',
    description: 'Camisolin de aislamiento descartable con punos ajustables.',
    abcCategory: 'common',
  },
  {
    id: 'supply-5',
    ...
    brand: 'INTRATUB',
    description: 'Canula nasal para administracion de oxigeno en adultos.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-6',
    ...
    brand: 'INTRA',
    description: 'Cateter venoso central de un lumen para acceso vascular.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-7',
    ...
    brand: 'ON E GLOVES',
    description: 'Guantes de examen de latex descartables no esteriles.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-8',
  ...
  },
  {
    ...
    brand: 'HARSORIA',
    description: 'Llave de tres vias para administracion y conexion de fluidos.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-10',
    ...
    brand: 'INTRATUB',
    description: 'Mascara de oxigeno para adulto con bolsa reservorio.',
    abcCategory: 'common',
  },
  {
    id: 'supply-11',
    ...
    brand: 'CONTINENTAL',
    description: 'Guia vascular calibre 14 para procedimientos clinicos.',
    abcCategory: 'flagship',
  },
  {
    id: 'supply-12',
    name: 'Guias con Regulador',
    brand: 'PREFIX',
    description: 'Guia medica con sistema regulador integrado.',
    abcCategory: 'flagship',
  },
  {
    id: 'supply-13',
    ...
    brand: 'MEDISPO',
    description: 'Guia con camara y medicion volumetrica para infusion.',
    abcCategory: 'flagship',
  },
  {
    id: 'supply-14',
    ...
    brand: 'CONTINENTAL',
    description: 'Tiras para controles rapidos de parametros clinicos.',
    abcCategory: 'common',
  },
  {
    id: 'supply-15',
    name: 'CATETER HEALCATH',
    brand: 'HEALCATH',
    description: 'Cateter descartable para procedimientos de acceso y drenaje.',
    abcCategory: 'flagship',
  },
  {
    id: 'supply-16',
    name: 'CATETER HEALCATH PLUS',
    brand: 'HEALCATH',
    description: 'Linea premium de cateteres para uso clinico de alta rotacion.',
    abcCategory: 'flagship',
  },
  {
    id: 'supply-17',
    name: 'COMPRESA DE GASAS COSIDA',
    brand: 'CONTINENTAL',
    description: 'Compresa de gasas para curaciones y procedimientos generales.',
    abcCategory: 'common',
  },
  {
    id: 'supply-18',
    name: 'GASAS NO TEJIDA',
    brand: 'MEDISPO',
    description: 'Gasa no tejida de uso frecuente para limpieza y cobertura.',
    abcCategory: 'common',
  },
  {
    id: 'supply-19',
    name: 'GUANTES SUPERMAX',
    brand: 'SUPERMAX',
    description: 'Guantes de examinacion para alto volumen de consumo.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-20',
    name: 'LAPIZ ELECTROBISTURI',
    brand: 'CONTINENTAL',
    description: 'Lapiz para electrobisturi con cable para procedimientos quirurgicos.',
    abcCategory: 'featured',
  },
  {
    id: 'supply-21',
    name: 'SUPER BOLSAS',
    brand: 'CONTINENTAL',
    description: 'Bolsa descartable de uso institucional para reposicion recurrente.',
    abcCategory: 'common',
  },
];

export const MOCK_CLIENT_SUPPLY_IDS: Record<string, string[]> = {
  'client-1': ['supply-1', 'supply-7', 'supply-8', 'supply-11', 'supply-12', 'supply-15'],
  'client-2': ['supply-2', 'supply-4', 'supply-9', 'supply-16', 'supply-17'],
  'client-3': ['supply-3', 'supply-5', 'supply-10', 'supply-13', 'supply-18'],
  'client-4': ['supply-1', 'supply-6', 'supply-8', 'supply-19'],
  'client-5': ['supply-2', 'supply-7', 'supply-10', 'supply-14', 'supply-20'],
  'client-6': ['supply-4', 'supply-9', 'supply-12', 'supply-21'],
  'client-7': ['supply-3', 'supply-5', 'supply-11', 'supply-16'],
  'client-8': ['supply-6', 'supply-8', 'supply-13', 'supply-17', 'supply-19'],
  'client-9': ['supply-1', 'supply-7', 'supply-9', 'supply-14', 'supply-20'],
  'client-10': ['supply-2', 'supply-5', 'supply-10', 'supply-12', 'supply-18'],
};
